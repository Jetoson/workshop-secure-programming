...
# Tutorial 05 - Buffer Overflow Fix Verifier

PASS=0
FAIL=0

echo "============================================================"
echo " Tutorial 05: Buffer Overflow - Verify Fix"
echo "============================================================"
echo ""
...
echo ""
echo "[TEST 2] 150-byte input must NOT crash the program..."
python3 -c "print('A' * 150)" | ./vuln_code > /dev/null 2>&1
EXIT_CODE=$?
